...
public class BoardEditController {
     ...
     * @throws Exception
     */
    @PostMapping(value = "{lang}/app/{userId}/board/add-participant", consumes = "application/json", produces = "application/json")
    ...
    @PostMapping(value = "{lang}/app/{userId}/board/remove-participant", consumes = "application/json", produces = "application/json")
     ...
     */
    @PostMapping("{lang}/app/{userId}/board/new")
     ...
     * @return Template name in case of errors or redirection command.
     */
    @PostMapping("{lang}/app/{userId}/board/{boardId}/edit/{boardId}/edit")
