...
create table person ( person_id integer auto_increment,  person_name varchar(50) not null,  primary key (person_id), constraint unique_person_name unique (person_name));
